...
export class EditPloegComponent implements OnInit {
  ...
  sponsors: Sponsor[];
  constructor(location: Location, private authenticationService: AuthenticationService, private router: Router, private activeRoute: ActivatedRoute, private sponsorSvc: SponsorService, private ploegService: PloegenService, private snackBar: MatSnackBar) {
