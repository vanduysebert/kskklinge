...
@Component({
  ...
  templateUrl: './jeugd-nieuws.component.html',
  styleUrls: ['./jeugd-nieuws.component.scss']
})
export class JeugdNieuwsComponent implements OnInit {
  events: Nieuws[];
  ...
  loadJeugdNieuws() {
    this.newsSvc.getNewsYouth().subscribe(ev => {
      this.events = ev;
